...
import type { SubmitResult } from "../home-reset-wizard.types";
    ...
    <div className="mx-auto max-w-lg space-y-6 py-8 text-center">
      ...
      <div className="space-y-3">
        <h1 className="text-3xl font-semibold tracking-tight text-slate-800 sm:text-4xl">
          {t("public.homeReset.success.title")}
        </h1>
        <p className="text-base leading-relaxed text-slate-500">{t("public.homeReset.success.subtitle")}</p>
      </div>
      <div className="rounded-3xl border border-stone-200/80 bg-white p-6 text-left shadow-[0_4px_24px_rgba(15,23,42,0.04)]">
        <p className="text-sm text-slate-400">{t("public.homeReset.success.orderRef")}</p>
