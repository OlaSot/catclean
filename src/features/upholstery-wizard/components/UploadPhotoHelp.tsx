...
export function UploadPhotoHelp() {
  ...
  function handleFileChange() {
    ...
    // Future: AI furniture recognition
  }
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <p className="text-xs leading-relaxed text-slate-600 sm:text-sm">
            <span className="font-semibold text-slate-800">Not sure what to choose?</span>
            <br className="hidden sm:block" />
            <span className="sm:ml-0">
              {" "}
              Upload a photo and we&apos;ll help you select the right option.
            </span>
          </p>
        </div>
